...
describe('AuthService', () => {
  ...
  describe('register', () => {
    ...
    it('should register a new user successfully', async () => {
      ...
      expect(mockUserRepository.findByLoginOrEmail).toHaveBeenCalledWith(
        'testuser',
        'test@example.com',
      );
  ...
  describe('login', () => {
    ...
    it('should login user successfully with correct credentials', async () => {
      ...
      expect(
        mockUserRepository.findByLoginOrEmailWithPassword,
  ...
  describe('refresh', () => {
    ...
    it('should refresh tokens successfully', async () => {
      ...
      expect(mockUserRepository.findByIdSelectId).toHaveBeenCalledWith(
        'user-id-123',
      );
